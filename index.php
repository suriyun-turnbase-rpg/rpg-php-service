...
$actions = array(
    ...
    'set-icons' => array('POST', 'SetPlayerIcon', array('iconDataId')),
    'set-frames' => array('POST', 'SetPlayerFrame', array('frameDataId')),
    'set-titles' => array('POST', 'SetPlayerTitle', array('titleDataId')),
    // Clan profile
    ...
    'set-clan-icons' => array('POST', 'SetClanIcon', array('iconDataId')),
    'set-clan-frames' => array('POST', 'SetClanFrame', array('frameDataId')),
    'set-clan-titles' => array('POST', 'SetClanTitle', array('titleDataId')),
    // Other services
